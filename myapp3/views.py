...
def post_detail(request, year, month, slug):
    ...
    return JsonResponse(post, json_dumps_params={'ensure_ascii': False})  # Задействует весь объем utf-8 кодировки
...
class TemplIf(TemplateView):
    template_name = "myapp3/templ_if.html"  # template_name зарезервированное имя
